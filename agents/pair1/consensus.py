...
class ConsensusEngine:
    ...
    def __init__(self):
        ...
        self.client = client
        self.system_prompt = Path("prompts/pair1/consensus_system_prompt.md" ).read_text(encoding="utf-8")
...
"""
    ...
    def analyze_batch(
        self,
        a1_outputs: list[AgentOutput],
        a2_outputs: list[AgentOutput],
    ) -> list[PairConsensusReport]:
