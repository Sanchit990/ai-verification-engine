...
class AgentOutput(BaseModel):
    ...
    confidence:float=Field(ge=0,le=1,description="Confidence level of verification")
    confidence_drop_reason:list[str]=Field(description="Reason to dropoff confidence")
